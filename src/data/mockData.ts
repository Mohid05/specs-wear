...
export const products: Product[] = [
  ...
  { id: 2, name: "Round Retro", price: 3800, category: "frames", gender: "unisex", image: "https://images.unsplash.com/photo-1614715838608-dd527c46231d?w=400&h=400&fit=crop", description: "Vintage-inspired round frames with a modern twist for effortless style.", specs: [{ label: "Material", value: "Acetate" }, { label: "Weight", value: "28g" }, { label: "Lens Width", value: "50mm" }, { label: "Bridge", value: "20mm" }] },
